#Author: Sohel Mahmud
#Date: 05-10-16
#Description: Comparing the genes (7108)of ACC patients (90) with ACC genes (7108) and creating a
#
...
with open('ACC_gene_mutation_record.csv','r') as fhand:
...
for key, lst_of_dct in mydata.items():
    ...
    for dct in lst_of_dct:                                          # dct is each dictionary(2 keys - patient ID and genes(list))
        ...
        print len(heading)                                          # print the number of total genes (7108)
        ...
        with open('ACC_gene_mutation_record.csv', 'a') as myfile:
